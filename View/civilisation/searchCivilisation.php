                    ...
                    <div class="card mb-4 shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <!-- Bouton Modifier -->
                                <a href="editCivilisation.php?id=<?= $civilisation['id']; ?>&search=<?= urlencode($search); ?>" class="btn btn-warning btn-sm">Modifier</a>
                                
                                <!-- Bouton Supprimer -->
                                <a href="deleteCivilisation.php?id=<?= $civilisation['id']; ?>&search=<?= urlencode($search); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette civilisation ?')">Supprimer</a>
                                
                                <!-- Bouton Voir éléments -->
                                <a href="searchCivilisationItems.php?civilisation_id=<?= $civilisation['id']; ?>" class="btn btn-info btn-sm">Voir éléments</a>
